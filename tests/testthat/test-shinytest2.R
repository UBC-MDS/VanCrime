...
test_that("{shinytest2} recording: should_return_empty_map_tab_1", {
  app <- AppDriver$new(name = "should_return_empty_map_tab_1", height = 857, width = 1406, load_timeout=100000)
